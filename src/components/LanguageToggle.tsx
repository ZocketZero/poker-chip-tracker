  ...
  return (
    <div className={`relative inline-block text-left ${className}`} ref={dropdownRef}>
      <button
        ...
        className={`flex items-center gap-1.5 bg-slate-900/90 hover:bg-slate-800/90 text-slate-200 border border-slate-700/80 rounded-xl transition-all cursor-pointer shadow-md focus:outline-none focus:ring-1 focus:ring-amber-400/50 active:scale-95 ${
      ...
      {isOpen && (
        <div className="absolute right-0 mt-1.5 w-36 bg-slate-900/95 border border-slate-700/90 rounded-xl shadow-2xl backdrop-blur-xl z-50 py-1 overflow-hidden animate-in fade-in zoom-in-95 duration-100 ring-1 ring-white/10">
